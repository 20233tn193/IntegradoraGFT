...
import Navbar from "../../components/navbar/Navbar"; // ✅ Agregado
import "./CreateCampos.css";
import topImage from "../../assets/Top.png";
import mapPlaceholder from "../../assets/mapa.png";
...
const CreateCampos = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Formulario enviado con:", field); // Aquí verás todo: nombre, canchas y ubicación
  ...
  const [visibleFields, setVisibleFields] = useState(1); // Muestra solo cancha 1 al inicio
